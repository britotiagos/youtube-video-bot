...
async function robot() {
  ...
  async function authenticateWithOAuth() {
    ...
    requestUseConsent(OAuthClient);
    const authorizationToken = await waitForGoolgeCallBack(webServer);
    ...
    function requestUseConsent(OAuthClient) {
    ...
    async function waitForGoolgeCallBack(webServer) {
      return new Promise((resolve, reject) => {
  ...
  async function uploadVideo(content) {
    ...
    const videoTitle = `${content.prefix} ${contentSearchTerm}`;
  ...
  async function uploadThumbnail(videoInformation) {
    ...
    console.log(`> Thumbnail uploades!`);
  }
}
